...
def insert_minifigure_data(no,name, tipo, category_id, image_url, thumbnail_url, weight, dim_x, dim_y, dim_z, year_released):
    query = """
    ...
    try:
        ...
        print("Errore durante l'inserimento della minifigura:", e)
        return False
